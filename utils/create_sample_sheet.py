        ...
        for file in files:
            ...
            if file.endswith(".nd2"):
                ...
                data_rows.append({
                    ...
                    "image": file_path,
                    "fixed": str(fixed).lower()  # Convert boolean to lowercase string
                })
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Scan a directory and generate a CSV file with patient_id, image paths, and fixed status.")
    parser.add_argument("--base_dir", required=True,help="Base directory to scan")
    parser.add_argument("--output_csv", default='sample_sheet.csv', help="Path to the output CSV file")
