...
def cell_segmentation(nuclei_img_orig, membrane_img_orig, custom_img_orig):
    if custom_segmentation == "" or custom_segmentation_type != "nuc":
        ...
        model = StarDist2D(
            None, 
            name='stardist_full_e200_lr00001_aug1_seed10_es50p0.001_rlr0.5p50', 
            basedir='/hpcnfs/scratch/DIMA/chiodin/tests/stardist_training_notebook/runs/20250514/runs/10/models'
        )
